...
#CFLAGS=		-g -Wall -Wextra -Wc++-compat -O2 -std=c11
...
$(PROG): main.o repCentroids.o EditDistance.o NJtree.o clusterTR.o kalloc.o handle_one_file.o region_complexity.o $(OBJS)
		$(CC) $(CFLAGS) $^ -o $@ $(LIBS_MORE) $(LIBS)
